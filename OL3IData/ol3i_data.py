...
from OL3IData.data_transforms import AugWaterbirdsCelebATransform
...
class OL3IDataset(Dataset):
    def __init__(self, basedir, split="train", transform=None):
        ...
        metadata_df = pd.read_csv(os.path.join(basedir, "ol3i_metadata.csv"))
...
def get_transform_ol3i(target_resolution, train, augment_data, custom_data_transform):
...
def get_loader_ol3i(data, train, reweight_groups, reweight_classes, reweight_places, **kwargs):
